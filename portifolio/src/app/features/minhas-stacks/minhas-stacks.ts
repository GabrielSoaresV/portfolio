  ...
  stacks: Stack[] = [
    {
      ...
      tags: ['Angular', 'React', 'TypeScript', 'Tailwind CSS', 'SASS'],
    ...
    {
      name: 'Backend',
      description: 'APIs RESTful, arquitetura limpa e sistemas escaláveis.',
      tags: ['Node.js', 'Python', 'Java', 'PostgreSQL', 'MongoDB'],
    ...
    },
    {
      ...
      tags: ['React Native', 'Flutter', 'Ionic', 'Swift', 'Kotlin'],
    ...
    {
      name: 'Design',
      description: 'Prototipagem, UI/UX e identidade visual de produtos digitais.',
      tags: ['Figma', 'Adobe XD', 'Photoshop', 'Illustrator', 'Blender'],
